...
<div data-role="page" class="ui-responsive-panel">
    ...
    <div data-role="content" class="jqm-contentx">
    		...
    		<li data-role="list-divider">La Notificación fue enviada a los siguientes expertos:</li>
   			<li><?php if ($data['cron_envio']) echo $data['cron_envio']; else echo "No hay muestras pendientes";?></li>
            </ul>
