 ...
 */
$dbconfig['dev'] = array('localhost', 'database', 'user', 'pass', 'mysql',true);
//$dbconfig['dev'] = array('localhost', 'mysql_webnostic', 'webnosticuser', 'webnosticuserpass', 'mysql',true);

//---------------------- Define the SITE (VAGINOSIS BACTERIAL,CANCER CERVICAL,MELANOMA,TUBERCULOSIS) ---------------------------------------------------------------- 

$config['SITE'] = 'tuberculosis';
