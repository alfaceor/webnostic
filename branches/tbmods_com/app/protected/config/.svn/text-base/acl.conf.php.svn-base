...
$acl['member']['deny'] = array(
                            'AdminController'=>array('addUser','list_all_users')
                        );
$acl['member']['failRoute'] = array(
                            '_default'=>'/error/loginfirst',
                        );

# member can access to the Sample controllers.
$acl['member']['allow'] = array(
                            
                            'SampleController'=>array('list_all','sampleResult'),'AdminController'=>array('updateUser','saveUser')
                        );
...
$acl['anonymous']['allow'] = array(
                            'MainController'=>array('index'),'SampleController'=>array('cron_sample'),'AdminController'=>array('cron_mail')
                            );
